<?php include('config.php'); ?>
		...
		if(isset($_POST['submit'])){
			...
			$Mgr_start_date		= $_POST['Mgr_start_date'];
				...
				$sql = mysqli_query($koneksi, "INSERT INTO department(Dname, Dnumber, Mgr_ssn, Mgr_start_date) VALUES('$Dname','$Dnumber','$Mgr_ssn','$Mgr_start_date')") or die(mysqli_error($koneksi));
		...
		<form action="index.php?page=tambah2" method="post">
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="text" name="Mgr_ssn" class="form-control" required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">Mgr_start_date</label>
				<div class="col-md-6 col-sm-6">
					<input type="date" name="Mgr_start_date" class="form-control" required>
				</div>
			</div>
